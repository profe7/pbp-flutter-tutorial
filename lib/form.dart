                                          ...
                                          child: Container(
                                            child: ListView(
                                              ...
                                              children: <Widget>[
                                                ...
                                                if (jenjangDiploma) Text('Jenjang : Diploma'),
                                                if (jenjangMagister) Text('Jenjang : Magister'),
                                                if (jenjangDoktor) Text('Jenjang : Doktor'),
                                                Text("Umur : "+umur.toString()),
                                                Text("Kelas : "+kelasPBP),
                                                if (_nilaiSwitch) Text('Mode : Practice Mode'),
                                                TextButton(
                                                  onPressed: () {
